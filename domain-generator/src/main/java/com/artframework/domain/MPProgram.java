...
public class MPProgram {
    ...
    public static void main(String[] args) throws IOException, JAXBException {
        ...
        DataSourceConfig dataSourceConfig= new DataSourceConfig.Builder("jdbc:postgresql://polar02.o.polardb.rds.aliyuncs.com:1521/general_module_dev","dev","Whalecloud!!!")
                .dbQuery(new MyPostgreSqlQuery("no_ddl"))
                .schema("no_ddl")
        ...
        GlobalSetting.loadFromDB(dataSourceConfig,
                new File("C:\\work\\Coding\\FW\\public-notarial\\public-notarial-be\\1-domain\\domain-act.xml"));
...
//                "C:\\work\\Coding\\FW\\public-notarial\\public-notarial-be\\present\\server\\src\\main\\java\\mo\\gov\\dsaj\\notarial\\server\\controller",
                "",
