...
public class GenerateUtils {
    ...
    public static void generateDomains(String path, String controllerPath, List<DomainMetaInfo> domainMetaInfoList, Map<String, String> packageParam) throws IOException {
    ...
    public static void generateTables(String daoPath, String doPath, List<TableMetaInfo> tableCollection, Map<String, String> packageParam) throws IOException {
